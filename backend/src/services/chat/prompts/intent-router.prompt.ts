...
- cv_job_match: user muốn tìm hoặc gợi ý job phù hợp với CV, hồ sơ hoặc resume của họ
- cv_match_previous_jobs: user muốn biết trong các job đã tìm/đã nhắc trước đó thì job nào phù hợp với CV của họ
...
- Nếu user yêu cầu tìm job phù hợp với CV/hồ sơ/resume của họ, chọn cv_job_match.
- Nếu user nhắc "các job đó", "mấy job vừa tìm", "trong danh sách trên" và hỏi job nào phù hợp với CV, chọn cv_match_previous_jobs.
