...
export const registerValidator = z.object({
  body: z
    .object({
      ...
      confirmPassword: z.string({ message: UserMessages.CONFIRM_PASSWORD_NOT_FOUND })
    })
